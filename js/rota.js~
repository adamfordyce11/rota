...
/*        t[++tp] = "  <form id='rotaPickForm'><fieldset id='rotaSettingsLeft'>";
      ...
      function initTable(obj) {
        ...
        tableData[++ele]="<table id='rota' width='100%' cellpadding='0' cellspacing='0' class='table table-sm table-md table-lg table-xl table-responsive'><thead id='rotaHeader'><tr><th scope='row' class='col-md-12' colspan='40'>"+obj.title+"</th></tr></thead>";
        tableData[++ele]="<tbody id='days'><tr id='dh' scope='row'><th scope='row' id='daytitle'>Day</th>";
