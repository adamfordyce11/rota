    ...
    var settings = $.extend({}, defaults, options);
      ...
      function newMonth(p) {
        ...
        $.get(settings.url, { 'request':"getLastEntry" }, null,"json").done(function(data){
          ...
          t[++tp] = "          <select multiple class='form-control' size='5' id='add'></select>";
          ...
          t[++tp] = "          <select multiple class='form-control' size='5' id='remove'></select>";
          t[++tp] = "          <div class='btn-group'>";
              ...
              $.each(d.data.booked,function(idx,data){
                ...
                if (data==0) {
                  ...
                  if (r.attr("weekend")=="yes") {
                    ...
                    r.text("1");
                    //r.html("<img style='width:12px;height:12px;vertical-align:middle;' src='img/full_star.png'>");
                  } else {
                    r.addClass("oncall");
...
/*        t[++tp] = "  <form id='rotaPickForm'><fieldset id='rotaSettingsLeft'>";
      ...
      function initTable(obj) {
        ...
        for (day=startDate;day<=endDate;day=sday+day){
          ...
          tableData[++ele]="<th class='fit p "+c+" "+today+"' year='"+y+"' month='"+m+"' day='"+d+"' id='"+totalDays+"' weekend='"+weekend+"'>"+dom+"</th>";
