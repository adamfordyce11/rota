...
/*        t[++tp] = "  <form id='rotaPickForm'><fieldset id='rotaSettingsLeft'>";
      ...
      function initTable(obj) {
        ...
        tableData[++ele]="<table id='rota' width='100%' cellpadding='0' cellspacing='0' class='table table-sm table-lg table-responsive'><thead id='rotaHeader'><tr><th scope='row' colspan='40'>"+obj.title+"</th></tr></thead>";
