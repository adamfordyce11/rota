...
/*        t[++tp] = "  <form id='rotaPickForm'><fieldset id='rotaSettingsLeft'>";
      ...
      function initTable(obj) {
        ...
        function drawChart() {
          ...
          dataTable.addRows([
            [ 'Adam Fordyce', 'Offshore', new Date(2017, 5, 5), new Date(2017, 5, 10) ],
            [ 'Salah Ahmed', 'Holiday', new Date(2017, 5, 4), new Date(2017, 5, 5) ],
            [ 'Paul Leslie', 'On Call', new Date(2017, 5, 3), new Date(2017, 5, 4) ]]);
...
//                  console.log(multi);
      ...
      main();
      // Update the table every 5000ms (5seconds)
