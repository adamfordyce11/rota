  ...
  <body>
    <div id="container">
      <div id="noappcontent">
        ...
        ?>
        <form method="post" id="registrationForm" name="registration_form" action="<?php echo esc_url($_SERVER['PHP_SELF']); ?>">
          <input type='text' name='username' id='username' placeholder="Firstname Surname"/><br>
